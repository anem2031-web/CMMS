  ...
  return (
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          <CardTitle className="flex items-center gap-2">
            ...
            {t("catalog.settings.dataEntry", "إعدادات إدخال البيانات")}
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="flex items-center justify-between p-4 bg-slate-50 rounded">
            <div>
              <p className="font-medium text-slate-900">
                {t("catalog.settings.requireSupplier", "إجبار إضافة مورد")}
              </p>
          ...
          <div className="flex items-center justify-between p-4 bg-slate-50 rounded">
            <div>
              <p className="font-medium text-slate-900">
                {t("catalog.settings.autoCode", "توليد الكود تلقائياً")}
              </p>
              <p className="text-sm text-slate-600">
                {t(
          ...
          <div className="flex items-center justify-between p-4 bg-slate-50 rounded">
            <div>
              <p className="font-medium text-slate-900">
                {t("catalog.settings.bulkImport", "السماح بالاستيراد الجماعي")}
              </p>
              <p className="text-sm text-slate-600">
                {t(
          ...
          <div className="flex items-center justify-between p-4 bg-slate-50 rounded">
            <div>
              <p className="font-medium text-slate-900">
                {t("catalog.settings.requireImage", "إجبار الصورة الرئيسية")}
              </p>
              <p className="text-sm text-slate-600">
                {t(
      ...
      <Card>
        <CardHeader>
          <CardTitle>
            {t("catalog.settings.system", "إعدادات النظام")}
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div>
            <label className="text-sm font-medium text-slate-900">
              {t("catalog.settings.maxImageSize", "الحد الأقصى لحجم الصورة (MB)")}
            </label>
            <Input
              type="number"
      ...
      <Card className="border-red-200 bg-red-50">
        <CardHeader>
          <CardTitle className="text-red-700">
            {t("catalog.settings.dangerZone", "منطقة الخطر")}
          </CardTitle>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <Button variant="destructive" className="w-full">
            {t("catalog.settings.resetCatalog", "إعادة تعيين الكتالوج")}
          </Button>
        </CardContent>
      </Card>
        ...
        <div>
          {saved && (
            <div className="flex items-center gap-2 text-green-600">
              ...
              <span>{t("common.saved", "تم الحفظ بنجاح")}</span>
            </div>
          )}
        </div>
        <Button
