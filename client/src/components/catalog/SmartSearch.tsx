  ...
  return (
    <div className="relative w-full">
      ...
      <div className="relative">
        ...
        <Input
          type="text"
          placeholder={t("catalog.search.placeholder", "ابحث عن صنف أو مورد...")}
          value={query}
            ...
            {isLoading ? (
              <div className="flex items-center justify-center py-8">
                ...
                <span className="ml-2 text-slate-600">
                  {t("catalog.search.searching", "جاري البحث...")}
                </span>
              </div>
            ) : results.length === 0 ? (
              <div className="py-8 text-center text-slate-500">
                {t("catalog.search.noResults", "لم يتم العثور على نتائج")}
              </div>
            ) : (
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-xs text-slate-500 mt-1">
                          {t("catalog.search.code", "الكود")}: {item.itemCode}
                        </p>
                      </div>
                    </div>
                  </div>
      ...
      {!isOpen && categories && categories.length > 0 && (
        <div className="mt-4">
          <p className="text-sm font-medium text-slate-600 mb-2">
            {t("catalog.search.categories", "الأقسام")}
          </p>
