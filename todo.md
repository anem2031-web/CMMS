...
- [ ] حفظ Checkpoint قبل التطوير
- [ ] تحديث Schema: جداول pm_templates و pm_checklist_items و pm_execution_results
- [ ] واجهة مدير الصيانة: إنشاء النماذج + Checklist Builder
- [ ] واجهة الفني: تنفيذ الفحص + عداد البنود + شريط التقدم
- [ ] تدفق الخلل: فتح بلاغ تلقائي مرتبط + إشعارات ملونة
