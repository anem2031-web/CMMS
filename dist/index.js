...
var appRouter = router({
  ...
  purchaseOrders: router({
    ...
    confirmDeliveryToRequester: warehouseProcedure.input(z4.object({
      ...
      if (allDelivered) {
        await updatePurchaseOrder(item.purchaseOrderId, { status: "received" });
        const po = await getPurchaseOrderById(item.purchaseOrderId);
        if (po?.ticketId) {
          ...
          if (ticket && ticket.maintenancePath !== "C" && !["received_warehouse", "ready_for_closure", "repaired", "verified", "closed"].includes(ticket.status)) {
            ...
            if (ticket.assignedToId) {
              await createNotification({ userId: ticket.assignedToId, title: "\u{1F4E6} \u062A\u0645 \u062A\u0633\u0644\u064A\u0645 \u0627\u0644\u0645\u0648\u0627\u062F - \u0623\u0643\u0645\u0644 \u0627\u0644\u0639\u0645\u0644", message: `\u062A\u0645 \u062A\u0633\u0644\u064A\u0645 \u062C\u0645\u064A\u0639 \u0645\u0648\u0627\u062F \u0627\u0644\u0628\u0644\u0627\u063A ${ticket.ticketNumber} \u0625\u0644\u064A\u0643. \u064A\u0631\u062C\u0649 \u0625\u062A\u0645\u0627\u0645 \u0627\u0644\u0639\u0645\u0644 \u0648\u0625\u0631\u0633\u0627\u0644\u0647 \u0644\u0644\u0625\u063A\u0644\u0627\u0642.`, type: "info", relatedTicketId: po.ticketId });
            }
            const managers = await getManagerUsers();
            for (const mgr of managers) {
              await createNotification({ userId: mgr.id, title: "\u{1F4E6} \u0645\u0648\u0627\u062F \u0628\u0644\u0627\u063A \u062C\u0627\u0647\u0632\u0629 \u0644\u0644\u0641\u0646\u064A", message: `\u062A\u0645 \u062A\u0633\u0644\u064A\u0645 \u062C\u0645\u064A\u0639 \u0645\u0648\u0627\u062F \u0627\u0644\u0628\u0644\u0627\u063A ${ticket.ticketNumber}. \u0628\u0627\u0646\u062A\u0638\u0627\u0631 \u0625\u062A\u0645\u0627\u0645 \u0627\u0644\u0641\u0646\u064A \u0644\u0644\u0639\u0645\u0644.`, type: "info", relatedTicketId: po.ticketId });
            }
          }
        }
      }
  ...
  app.get("/api/health", async (_req, res) => {
    ...
    try {
      ...
      if (db) {
        ...
        return res.status(200).json({ status: "ok", timestamp: timestamp2, database: "connected", uptime });
      } else {
        return res.status(503).json({ status: "degraded", timestamp: timestamp2, database: "disconnected", uptime });
      }
    } catch {
      return res.status(503).json({ status: "degraded", timestamp: timestamp2, database: "disconnected", uptime });
    }
