...
export async function listMainPlans() {
  ...
  const rows = await db
    .select({
      ...
      branchTitle_ar: preventivePlans.titleAr,
      branchTitle_en: preventivePlans.titleEn,
      branchTitle_ur: preventivePlans.titleUr,
...
export async function listOperationalBranchesWithoutMainPlan() {
  ...
  const roots = await db
    .select({
      ...
      title_ar: preventivePlans.titleAr,
      title_en: preventivePlans.titleEn,
      title_ur: preventivePlans.titleUr,
      siteId: preventivePlans.siteId,
      siteName: sites.name,
      siteNameEn: sites.nameEn,
      siteNameUr: sites.nameUr,
...
export async function listSubPlans(mainPlanId: number) {
  ...
  return db
    .select({
      ...
      title_ar: pmSubPlans.titleAr,
      title_en: pmSubPlans.titleEn,
      title_ur: pmSubPlans.titleUr,
      ...
      description_ar: pmSubPlans.descriptionAr,
      description_en: pmSubPlans.descriptionEn,
      description_ur: pmSubPlans.descriptionUr,
      ...
      sectionTitle_ar: preventivePlans.titleAr,
      sectionTitle_en: preventivePlans.titleEn,
      sectionTitle_ur: preventivePlans.titleUr,
    })
    .from(pmSubPlans)
